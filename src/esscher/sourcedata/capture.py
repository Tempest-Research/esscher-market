...
from esscher.contracts.source_matrix import CONDITIONS, source_matrix_bytes
...
from esscher.sourcedata.rights_gate import evaluate_capture_rights
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="python -m esscher.sourcedata.capture",
