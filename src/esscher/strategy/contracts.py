...
def reasoner_policy_hashes(candidate_id: str) -> tuple[str, str, str]:
    ...
    from esscher.strategy.policy import load_strategy_policy, load_strategy_policy_v3
...
def _v2_article_attribution_payload(value: object) -> dict[str, object]:
    from esscher.sourcedata.alpaca_news import ArticleAttribution
...
def _v2_reasoner_prompt_material(
    ...
    from esscher.strategy.policy import load_strategy_policy_v2, strategy_policy_v2_bytes
...
def _v2_direction_route_request_fields(route: object, request: object) -> dict[str, object]:
    from esscher.contracts.reasoner_route import ValidatedRoute
    from esscher.strategy.host_route import KimiK3Request
