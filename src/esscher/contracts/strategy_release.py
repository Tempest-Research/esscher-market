...
def current_semantic_ids() -> dict[str, str]:
    ...
    from esscher.autonomy.policy import load_autonomous_policy
    from esscher.contracts.execution_policy import PAPER_PERMIT_POLICY_VERSION
    ...
    from esscher.contracts.source_matrix import load_source_matrix
