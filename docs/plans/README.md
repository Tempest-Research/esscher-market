...
Add each only after the complete artifact and its cited sources are available. Reconcile findings into `CURRENT.md` separately; copying a report into this directory does not approve it.
