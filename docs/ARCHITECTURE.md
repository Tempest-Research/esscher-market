...
The residual return removes frozen market and sector components measured over the same achievable-entry window. `UNCERTAIN` maps to zero but remains in the panel. This prevents the system from deleting difficult events after seeing their outcomes.

## Non-negotiable invariants

1. No evidence or feature timestamp may exceed the decision cutoff.
2. Entry starts at the first observable price at or after the modeled latency.
