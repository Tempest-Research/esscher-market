...
def test_v4_furry_gateway_package_is_a_dormant_alternate() -> None:
    # The current route pivoted to V5 (qwen3.8-max-0902 via official DashScope)
    # after the free furry.vg gateway's disclosed evening concurrency caps
    # (429 "at concurrency limit") threatened live-session abstentions; V4
    # remains packaged, loadable, and unchanged as a dormant alternate.
    ...
    # V3 MiniMax remains packaged and loadable as a dormant alternate too.
