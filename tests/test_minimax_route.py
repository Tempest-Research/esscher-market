...
def test_current_approved_route_is_the_v3_minimax_package() -> None:
    assert load_current_approved_reasoner_route() is load_approved_reasoner_route_v3()
    # The dormant Kimi V2 alternate remains packaged and loadable, unchanged.
